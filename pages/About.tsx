      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mt-12">
          ...
          <div className="relative group">
            <div className="absolute inset-0 border border-gold/20 translate-x-4 translate-y-4 -z-10 transition-transform duration-500 group-hover:translate-x-2 group-hover:translate-y-2"></div>
             <div className="absolute inset-0 border border-white/10 -translate-x-4 -translate-y-4 -z-10 transition-transform duration-500 group-hover:-translate-x-2 group-hover:-translate-y-2"></div>
            <img 
              src={about.image} 
              alt="About Us" 
              className="w-full h-[600px] object-cover filter grayscale hover:grayscale-0 transition-all duration-700 shadow-2xl"
            />
          </div>
